...
export default function EditListing({ token }) {
  ...
  return (
    <div>
      ...
      <input placeholder="Property Type" value={propertyType} onChange={e => setPropertyType(e.target.value)} />
      <input placeholder="Bathrooms" type="number" value={bathrooms} onChange={e => setBathrooms(e.target.value)} />
      ...
      <input placeholder="Images (comma separated URLs)" value={images.join(', ')} onChange={e => setImages(e.target.value.split(',').map(i => i.trim()))} />
